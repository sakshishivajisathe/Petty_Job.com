			...
			if(pg_num_rows($r)>0)
			{
				...
				if($_POST['password']==$r1[0])
				{
					...
					$r1="select userid from j_login where username='".$_POST['username']."'";
                        		...
                        		$_SESSION['type']='s';
                        		$r2="update post_job set remarks=1,a_u_id=".$_SESSION['userid']." where job_id=".$_SESSION['job_id'].";";
                        		$r3=pg_query($p,$r2);
					if($r3)
					{
						echo 'applied';
						$_SESSION['job_id']=$_SESSION['job_id'];
					}
					else
					{
						echo "error";
					}
					echo "<script>window.location.href='../job-detail.php'</script>";
				}
				else
				{

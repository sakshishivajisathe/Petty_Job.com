        ...
        <div class="container">
			...
			{	
                        	...
                        	if($e)
                        	{
                        		...
                        		$r2="insert into j_login(userid, username,password,access) values(".$array[0].",'".$_POST['email']."','".$_POST['password']."','seeker');";
                        		$e=pg_query($p,$r2);
                        		if($e)
                        		{
                        		echo "registered";
                        		echo "<script>window.location.href='login_s.php'</script>";
                        		}
                        	}
                        }

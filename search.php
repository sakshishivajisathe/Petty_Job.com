...
<!-- Navbar Start -->
        ...
        <div class="container-xxl py-5">
			...
			if($p)
			{
				...
				$q="select * from post_job where job_title ilike '%".$_POST['key']."%' or category='".$_POST['cat']."';";
				$r=pg_query($p,$q);
				if(!$r)
				{
					echo "error!!";
				...
				Apply Now-><input type='submit' name='id' value='".$t[0]."' class='btn btn-secondary py-md-2 px-md-3' style='background: #61045f'></a>
				</div>
